<template>
    <tr>
        ...
        <td style="text-align: center;"><v-btn :color="isSpectator ? 'red-darken-3' : 'green-darken-3'"
                :icon="isSpectator ? 'mdi-minus' : 'mdi-plus'" variant="plain" @click="toggleSpectator()" :disabled="isCollaborater"/></td>
        <td style="text-align: center;"><v-btn :color="isCollaborater ? 'red-darken-3' : 'green-darken-3'"
                :icon="isCollaborater ? 'mdi-minus' : 'mdi-plus'" variant="plain" @click="toggleCollaborater()" /></td>
    </tr>
</template>
...
const props = defineProps<{ account: Account, isCollaborater:boolean, isSpectator:boolean }>()
